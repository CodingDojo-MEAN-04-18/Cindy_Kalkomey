...
// this connects to whatever the database is named here (or what you want it to be named if it has not yet been created). The db name is not referenced in the code anywhere else. It is named anonnotes here.
mongoose.connect('mongodb://localhost/anonnotes');
mongoose.connection.on('connected', () => console.log('DATABASE Connected to MongoDB anonnotes'));
